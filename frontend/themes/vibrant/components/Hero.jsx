    ...
    <header className="relative py-24 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight drop-shadow-lg animate-fade-in">{title}</h1>
          {subtitle && <p className="text-2xl text-purple-50 leading-relaxed drop-shadow">{subtitle}</p>}
          {image && (
