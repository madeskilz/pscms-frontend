    ...
    <Box component="footer" sx={{ py: 10, mt: 12, bgcolor: theme.colors.surface, borderTop: `4px solid ${theme.colors.primary}`, boxShadow: '0 -4px 20px rgba(0,0,0,0.05)' }}>
      <Container maxWidth="lg">
        <Grid container spacing={5}>
          <Grid item xs={12} md={4}>
            <Box sx={{ width: 56, height: 56, bgcolor: theme.colors.primary, borderRadius: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 2.5, boxShadow: 3 }}>
              <Typography variant="h5" sx={{ color: '#fff', fontWeight: 700 }}>S</Typography>
            </Box>
          ...
          <Grid item xs={12} md={3}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Link href="mailto:info@school.test" underline="hover" variant="body2" color="text.secondary" sx={{ transition: 'color 0.2s', '&:hover': { color: 'primary.main' } }}>
                📧 info@school.test
              </Link>
        ...
        <Box sx={{ textAlign: 'center' }}>
          <Typography variant="body2" color="text.secondary" fontWeight={500}>© {currentYear} K12 School CMS. All rights reserved.</Typography>
